      ...
      <div className="w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="relative overflow-hidden rounded-[40px] border border-zinc-800 bg-zinc-900/40 p-10 shadow-2xl backdrop-blur-2xl">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-4 text-balance text-sm leading-relaxed text-zinc-400">
              Connect with India&apos;s most trusted astrologers through secure,
              high‑definition video sessions. Unlock your cosmic potential.
            </p>
            ...
            <div className="mt-10 w-full space-y-4">
              <button
                ...
                disabled={loading}
                className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-2xl bg-white px-6 py-4 text-sm font-semibold text-black transition-all hover:bg-zinc-100 active:scale-[0.98] disabled:opacity-50"
              >
                {loading ? (
            ...
            <div className="mt-10 flex items-center gap-6">
              ...
              <p className="text-xs text-zinc-500">Secure & Confidential</p>
              <div className="h-px w-8 bg-zinc-800" />
            </div>
          </div>
        </div>
